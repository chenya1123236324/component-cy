...
!function (_sha256) {
     ...
     */
    _sha256.sha256=function(s) {
        return rstr2hex(rstr_sha256(str2rstr_utf8(s)));
    }

    _sha256.base64_sha256=function(s) {
        return rstr2b64(rstr_sha256(str2rstr_utf8(s)));
    }

    var any_sha256=function(s, e) {
        return rstr2any(rstr_sha256(str2rstr_utf8(s)), e);
    }

    var hex_hmac_sha256=function(k, d) {
        return rstr2hex(rstr_hmac_sha256(str2rstr_utf8(k), str2rstr_utf8(d)));
    }

    var b64_hmac_sha256=function(k, d) {
        return rstr2b64(rstr_hmac_sha256(str2rstr_utf8(k), str2rstr_utf8(d)));
    }

    var any_hmac_sha256=function(k, d, e) {
     ...
     */
    var rstr_hmac_sha256=function(key, data) {
