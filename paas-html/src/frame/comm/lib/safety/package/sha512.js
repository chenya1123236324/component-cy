...
!function (_sha512) {
     ...
     */
    _sha512.sha512=function(s) {
        return rstr2hex(rstr_sha512(str2rstr_utf8(s)));
    }

    _sha512.base64_sha512=function(s) {
        return rstr2b64(rstr_sha512(str2rstr_utf8(s)));
    }

    var any_sha512=function(s, e) {
        return rstr2any(rstr_sha512(str2rstr_utf8(s)), e);
    }

    var hex_hmac_sha512=function(k, d) {
        return rstr2hex(rstr_hmac_sha512(str2rstr_utf8(k), str2rstr_utf8(d)));
    }

    var b64_hmac_sha512=function(k, d) {
        return rstr2b64(rstr_hmac_sha512(str2rstr_utf8(k), str2rstr_utf8(d)));
    }

    var any_hmac_sha512=function(k, d, e) {
     ...
     */
    var rstr_hmac_sha512=function(key, data) {
    ...
    var binb_sha512=function(x, len) {
...
//The var revrrot=function() is for that
