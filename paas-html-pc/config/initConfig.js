...
config(function($app,$appConfig){
    ...
    $app.extendConfig({
        ...
        //指令注册
        directiveRegister:$appConfig.COMM+'/directive/index.js',
        //组件注册
        componentRegister:$appConfig.COMM+'/component/index.js',
        //api服务注册
        apisServerRegister:$appConfig.APP_CONFIG+'/registerConfig/serverRegister/api.js',
        //socketApi服务注册
        socketApiServerRegister:$appConfig.APP_CONFIG+'/registerConfig/serverRegister/socket.js',
        //表达式过滤器注册
        filterPackage:$appConfig.APP_CONFIG+'/registerConfig/filterRegister/filterPackage.js',
        //api路径配置
        apiUrlMapConfig:$appConfig.APP_CONFIG+'/customConfig/apiUrlMapConfig.js',
        //公共配置
        commConfig:$appConfig.APP_CONFIG+'/customConfig/commConfig.js'
    });

    //加载自定义模式
    $app.loadConfig('apiUrlMap','comm');
