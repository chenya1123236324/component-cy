...
model('homeMenu',function(){
    this.$model = {
        ...
        menuBaseInformation:{
            ...
            companyLink:'home/index.html',//【必填】公司logo点击链接
            menuIcon:'icon-menu',//【必填】主菜单图标
            homeIcon:'icon-index-copy',//【必填】首页图标
            homeLink:'home/index.html',//【必填】首页点击链接
            MessageNumber:'3',//【必填】消息数量，默认为0
            MessageLink:'home/index.html',//【必填】消息数量，默认为0
            userHead:'./comm/style/less/component/homeMenu/menu-head.png',//【必填】用户头像
            userName:'纪小蓝',//【必填】用户名称
            userInformation:'<a href="./admin/personalInformation/personalInformation.html">个人信息</a>',//【非必填】用户信息--[预留功能,后期需要添加]
            settingLink:'home/index.html',//【必填】设置链接
            style: {          //【非必填】预留功能
            },
            list:[]
            ...
            menuList:[
                {
                    ...
                    link:'home/index.html',//【必填】当不在菜单头部显示孩子节点时，需要给当前显示的菜单加上链接
                    groupName:'客户', //分组名称
                    list:[
                        {
                            menuLink:'home/index.html', //【必填】菜单链接
