<div class="module-list">
    ...
    <div class="list-bottom module-list-bottom">
        ...
        <div id="highlighter_856655" style="padding:30px 0;top:190px;" class="syntaxhighlighter  js">
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="code">
                        <div class="container">
                            <div class="line number1 index0 alt2"><code class="js plain">model(</code><code
                                    class="js string">'currentLocation'</code><code class="js plain">,</code><code
                                    class="js keyword">function</code><code class="js plain">(){</code></div>
                            <div class="line number2 index1 alt1"><code class="js spaces">
                                &nbsp;&nbsp;&nbsp;&nbsp;</code><code class="js keyword">this</code><code
                                    class="js plain">.$model=[{</code></div>
                            <div class="line number3 index2 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">leftColor:</code><code class="js string">'#00a79d'</code><code
                                    class="js plain">,&nbsp;&nbsp;</code><code class="js comments">//左侧内容背景颜色</code>
                            </div>
                            <div class="line number4 index3 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">rightColor:</code><code class="js string">'#26b7ae'</code><code
                                    class="js plain">,&nbsp;</code><code class="js comments">//右侧内容背景颜色</code></div>
                            <div class="line number5 index4 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">activeColor:</code><code class="js string">'#21c3b9'</code><code
                                    class="js plain">,&nbsp;</code><code class="js comments">//右侧内容鼠标悬浮背景颜色</code></div>
                            <div class="line number6 index5 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">verticalLine:</code><code class="js string">'1px&nbsp;solid&nbsp;#5abfb9'</code><code
                                    class="js plain">,</code><code class="js comments">//右侧内容竖线颜色</code></div>
                            ...
                            <div class="line number9 index8 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">isLocation:</code><code class="js keyword">true</code><code
                                    class="js plain">,</code><code class="js comments">//是否是当前位置</code></div>
                            <div class="line number10 index9 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">locationName:</code><code class="js string">'公海客户'</code><code
                                    class="js plain">,</code><code class="js comments">//左侧当前位置名称</code></div>
                            <div class="line number11 index10 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">href:</code><code class="js string">'/admin/currentLocation/currentLocation.html'</code><code
                                    class="js plain">,</code></div>
                            ...
                            <div class="line number14 index13 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    ...
                                    class="js plain">,</code><code class="js keyword">this</code><code class="js plain">.innerHTML,event)</code>
                            </div>
                            ...
                            <div class="line number18 index17 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">isLocation:</code><code class="js keyword">false</code><code
                                    class="js plain">,</code><code class="js comments">//是否是当前位置</code></div>
                            <div class="line number19 index18 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">locationName:</code><code class="js string">'区域公海'</code><code
                                    class="js plain">,</code><code class="js comments">//右侧位置名称</code></div>
                            ...
                            <div class="line number28 index27 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">locationName:</code><code class="js string">'重点客户'</code><code
                                    class="js plain">,</code><code class="js comments">//右侧位置名称</code></div>
                            ...
                            <div class="line number37 index36 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">locationName:</code><code class="js string">'潜在客户'</code><code
                                    class="js plain">,</code><code class="js comments">//右侧位置名称</code></div>
                            ...
                            <div class="line number45 index44 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">]</code></div>
                            <div class="line number46 index45 alt1"><code class="js spaces">
