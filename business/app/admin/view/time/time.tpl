<div class="module-list">
    ...
    <div class="list-bottom module-list-bottom">
        <div style="margin:50px 0">
            <form-layout config="time"></form-layout>
        </div>
        <div id="highlighter_438846" style="padding:30px 0" class="syntaxhighlighter  js">
                    ...
                    <td class="code">
                        <div class="container">
                            <div class="line number1 index0 alt2"><code class="js spaces">&nbsp;&nbsp;</code><code
                                    class="js keyword">this</code><code class="js plain">.$model={</code></div>
                            ...
                            <div class="line number8 index7 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">title:</code><code class="js string">'选择时间'</code><code
                                    class="js plain">,</code></div>
                            <div class="line number9 index8 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">require:</code><code class="js keyword">true</code><code
                                    class="js plain">,</code></div>
                            ...
                            <div class="line number11 index10 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">type:</code><code class="js string">'time'</code><code
                                    class="js plain">,</code></div>
                            <div class="line number12 index11 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">value:</code><code class="js string">'22:01:29'</code><code
                                    class="js plain">,</code></div>
                            <div class="line number13 index12 alt2"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">placeholder:</code><code class="js string">'请选择时间'</code><code
                                    class="js plain">,</code></div>
                            ...
                            <div class="line number20 index19 alt1"><code class="js spaces">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</code><code
                                    class="js plain">]</code></div>
                            <div class="line number21 index20 alt2"><code class="js spaces">
